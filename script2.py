...
os.system("bedtools intersect -a bed-37/bed_chr_{}_sorted.bed -b {} > resultgenehg19{}.bed".format(sys.argv[3],sys.argv[1],sys.argv[3]))
...
w3 = open("gccoords_{}2defhg19.bed".format(sys.argv[3]),"w")
a  = ""
for line in op:
        line = line.strip()
        line = line.split()
...
os.system("uniq gccoords_{}2defhg19.bed > gccoords_{}_undefhg19.bed".format(sys.argv[3],sys.argv[3]))
os.system("uniq resultgenehg19{}.bed | awk  '!seen[$4]++' > resultgenehg19{}_un.bed".format(sys.argv[3],sys.argv[3]))
os.system("bedtools intersect  -a bed-37/bed_chr_{}_sorted.bed -b gccoords_{}_undefhg19.bed | awk  '!seen[$4]++' > intmuthg19{}.bed".format(sys.argv[3],sys.argv[3],sys.argv[3])) 
d1 = subprocess.check_output('wc -l intmuthg19{}.bed'.format(sys.argv[3]),shell = True) #look at the number of mutations
d2 = subprocess.check_output('wc -l resultgenehg19{}_un.bed'.format(sys.argv[3]), shell = True)
