...
while read -r i j; do
    ...
    if [[ -n $i && -n $j ]]; then
        ...
        input_filename="../control/gccoords_percents_${i}_my_39_subtract_from_all_filtered_without_quadr_and_CG_loop7_intergene.txt"
        output_filename="../filtered/max_all_39_${i}_gc_filtered_without_quadr_and_CG_loop7_intergene.txt"
